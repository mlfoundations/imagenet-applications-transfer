...
def get_melanoma():
    ...
    testset = MelanomaDataset(data_path, train=False, transform=transform, metadata=metadata)
    ...
    transform_train = transforms.Compose([
                    ...
                    transforms.ToTensor(),
                    transforms.Normalize(mean, std)])
    trainset = MelanomaDataset(data_path, transform=transform_train, metadata=metadata)
